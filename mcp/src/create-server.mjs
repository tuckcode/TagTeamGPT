...
export function createServer(root = resolveRoot()) {
  const server = new McpServer({
    name: "codexgpt-workspace",
    version: "0.1.0",
    instructions: `CodexGPT control plane (keyboard, not mouse hunting):
...
• Humans dump your reply into the auto-loop via Chat’s copy control, then: pbpaste | node tools/codexgpt-write-reply.mjs --from-clipboard (AX scrape is unreliable on Electron).
